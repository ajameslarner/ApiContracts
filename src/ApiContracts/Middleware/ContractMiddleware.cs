...
/// <summary>
/// The contract middleware class that validates the request body against the acceptance criteria defined on the model.
/// </summary>
/// <param name="next">The next delegate type</param>
public class ContractMiddleware(RequestDelegate next)
{
    ...
    /// <summary>
    /// The invoke method that validates the request body against the acceptance criteria defined on the model.
    /// </summary>
